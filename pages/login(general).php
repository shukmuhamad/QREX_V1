            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Please Sign In (General)</h3>
                    </div>
                        ...
                        try {
                                ...
                                if ($row == 1) {
                                    ...
                                    if($PositionKey == 2){
                                        ...
                                        echo "<center><labe style = 'color:red;'>Badge ID Staff detected, Please insert Badge Id and password General</label></center>";
                        
                                    }
                                    else{
                                        echo "<center><labe style = 'color:red;'>Badge ID Worker detected, Please insert Badge Id and password GeneralS</label></center>";
