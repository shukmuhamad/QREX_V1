...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="page(staff).php"><b>TOP GLOVE-(QREX)</b></a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="tables_FG.php"><i class="fa fa-table fa-fw"></i> All Finished Good Inspection Records (FG)</a>
                        </li>

                        <li>
                            <a href="tables_SFG.php"><i class="fa fa-table fa-fw"></i> All Semi-Finished Good Inspection Records (SFG)</a>
                        </li>
                ...
                <div class="col-lg13">
                    <div class="panel panel-primary" >
                        <div class="panel-heading">
                            Inspection Record Result (Semi Finished Good)
                        </div>
                        <!-- /.panel-heading -->
	...
	$(document).ready(function(){
	  ...
	  var table= $('#tableID').dataTable(
             ...
             "bProcessing": true,
			"pagingType": "numbers",
            "enable_pagecount" : false,
			"sAjaxSource": "ajaxlistSFG.php",
			"aoColumns": [
                {
                 sortable: false,
                 "render": function ( data, type, full, meta ) {
                     var lotid = full.LotIDKey;
                     return '<a class = "btn btn-success" href = "formqrex_viewSFG.php?LotIDKey='+lotid+'" target="_blank"><i class = "glyphicon glyphicon-show"></i> VIEW</a>';
                 }
             },
				{ mData: 'LotIDKey' } ,
