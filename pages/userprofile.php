            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="tables_FG.php"><i class="fa fa-table fa-fw"></i> All Finished Good Inspection Records</a>
                        </li>
                        <li>
...
<?php                                     
	...
	if(ISSET($_POST['update'])){
		...
		$name = $_POST['name'];
		$conn->query("UPDATE `staff` SET `id_staff` = '$id_staff', `password` = '$password', `name` = '$name' WHERE `badge_id` = '$_REQUEST[badge_id]'") or die(mysqli_error());
