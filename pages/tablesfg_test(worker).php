...
<tr>
            ...
            <td><center><a class = "btn btn-success" href = "formqrex_viewSFG(worker).php?LotIDKey=<?php echo $row['LotIDKey']?>" target="_blank"><i class = "glyphicon glyphicon-show"></i> VIEW</a></center></td>
