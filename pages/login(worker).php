...
<nav style = "background-color:rgba(0, 0, 0, 0.1);" class = "navbar navbar-default">
		<div  class = "topnav-right">
			<div class = "navbar-header">
				<a class = "navbar-brand" >TOP GLOVE- QA PQC INSPECTION MODULE</a>
			</div>
		</div>
	</nav>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Please Sign In (Worker)</h3>
                    </div>
                    <div class="panel-body">
                        <form role="form" method="post">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Badge Id" name="BadgeID" type="badge_id" required>
                                </div>
                                <div class="form-group">
                        ...
                        try {
                                ...
                                if ($row == 1) {
                                    ...
                                    if($PositionKey == 0){
                                        ...
                                        header("location: page(worker).php");
                                
                                    }
                                    else if($PositionKey == 1){
                                        echo "<center><labe style = 'color:red;'>Badge ID Staff detected, Please insert Badge Id and password Worker</label></center>";
                        
                                    }
                                    else{
                                        echo "<center><labe style = 'color:red;'>Badge ID General detected, Please insert Badge Id and password Worker</label></center>";
