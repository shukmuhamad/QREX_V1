                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                                        ...
                                        <?php 
                                            $query = $connect->prepare("SELECT * FROM DimProductionLine ORDER BY ProductionLineName ASC");
                                            $query->execute();
                                            $fetch = $query->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                ...
                <div class="col-lg-6">
                        ...
                        <div class="panel-body">
                                <div class="table-responsive">
                                 <div class="form-group">
                                 Verify by: <input class="form-control" type="number" name="verify_by" placeholder="Enter BadgeID"><br>     
                                   </div>
