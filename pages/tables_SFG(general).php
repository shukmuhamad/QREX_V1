    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="page(general).php"><b>TOP GLOVE-(QREX)</b></a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="tables_FG(general).php"><i class="fa fa-table fa-fw"></i> All Finished Good Inspection Records (FG)</a>
                        </li>
			...
			"aoColumns": [
                {
                 ...
                 "render": function ( data, type, full, meta ) {
                     ...
                     return '<a class = "btn btn-success" href = "formqrex_viewSFG(general).php?LotIDKey='+lotid+'" target="_blank"><i class = "glyphicon glyphicon-show"></i> VIEW</a>';
                 }
             },
				{ mData: 'LotIDKey' } ,
